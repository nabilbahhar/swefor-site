    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fade-in-up">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div
            className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm animate-fade-in-up"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        {Object.entries(destinationGroups).map(([country, countryTravels], countryIndex) => (
          <div key={country} className="animate-fade-in-up" style={{ animationDelay: `${countryIndex * 0.1}s` }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {countryTravels.map((trip, index) => (
                <div
                  ...
                  style={{ animationDelay: `${(countryIndex + index) * 0.05}s` }}
                >
