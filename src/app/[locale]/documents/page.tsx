...
import { FileText, File, Table, Mail, Plane, BookOpen, Shield, FolderOpen, Download } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fade-in-up">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-4xl mx-auto">
          {categoryOrder.map((cat, index) => {
            ...
            return (
              <div key={cat} className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center shadow-sm animate-fade-in-up" style={{ animationDelay: `${index * 50}ms` }}>
      ...
      {categoryOrder.map((categoryName, categoryIndex) => {
        ...
        return (
          <section key={categoryName} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 animate-fade-in-up" style={{ animationDelay: `${categoryIndex * 100}ms` }}>
            <div className="flex items-center gap-3 mb-6 animate-fade-in-up">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-full">{docs.length} files</span>
            </div>
              ...
              {docs.map((doc, index) => {
                ...
                return (
                  <a
                    ...
                    download
                    className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm hover:shadow-md hover:bg-blue-50/50 dark:hover:bg-gray-700/50 transition-all flex items-center gap-4 animate-fade-in-up cursor-pointer group"
                  ...
                  >
                    ...
                    <Download className="w-5 h-5 text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors flex-shrink-0" />
                  </a>
                );
              })}
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in-up">
        <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6 text-center animate-fade-in-up">
          <h3 className="font-bold text-gray-900 dark:text-white mb-2">Document Source</h3>
